...
public class Player2 : MonoBehaviour {
    ...
    public void Click()
    {
        ...
        if (playerClass == 1)
        {
            ...
            GameObject theEnemy = GameObject.Find("Enemy2");
            Enemy2 enemyscript = theEnemy.GetComponent<Enemy2>();
        ...
        if (playerClass == 2)
        {
            if (turn == 1)
            {
                // Special attacks based on if smoke screen is up or not to trigger passive
                GameObject theEnemy = GameObject.Find("Enemy2");
                Enemy2 enemyscript = theEnemy.GetComponent<Enemy2>();
